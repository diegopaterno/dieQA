...
public class TC_08_API_PP{
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_08_API_PP\r\n");
			...
			//PUT - Cambio de estado Cuenta - Activa
			...
			if(!resp.equals("0")) {
				...
				report.AddLine("Validacion exitosa:<br>El estado de la cuenta es: 0 y es igual al de la base de datos: " + resp);
				System.out.println("##[section] : Validacion exitosa:\r\nEl estado de la cuenta es: 0 y es igual al de la base de datos: " + resp + "\r\n");
			}
