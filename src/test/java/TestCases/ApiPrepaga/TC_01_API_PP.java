...
public class TC_01_API_PP {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_01_API_PP\r\n");
			...
			if (idCta != (Integer.valueOf(rtaIdCta))) {
				report.AddLineAssertionError("Error:<br>El id generado por la API AltaCuentaVirtual: " + idCta + " y es diferente al cargado en la base: " + rtaIdCta);
				System.out.println("##[warning] : Error:\r\n El id generado por la API AltaCuentaVirtual: " + idCta + " y es diferente al cargado en la base: " + rtaIdCta + "\r\n");
				//Si falla la validacion el resultado de la prueba es false
				result = false;
			} else {
				report.AddLine("Validacion exitosa:<br>El id generado por la API AltaCuentaVirtual: " + idCta + " y es igual al cargado en la base: " + rtaIdCta + "\r\n");
				System.out.println("##[section] : Validacion exitosa:\r\nEl id generado por la API AltaCuentaVirtual: " + idCta + " y es igual al cargado en la base: " + rtaIdCta + "\r\n");				
			}
			...
			if (soporteFisicoEsperado.equals(rtaSoporteFisico)) {
				report.AddLine("Validacion exitosa:<br> El SOPORTE_FISICO esperado es: " + soporteFisicoEsperado + " y es igual al de la base de datos: " + rtaSoporteFisico + "\r\n");
				System.out.println("##[section] : Validacion exitosa:\r\n El SOPORTE_FISICO esperado es: " + soporteFisicoEsperado + " y es igual al de la base de datos: " + rtaSoporteFisico + "\r\n");	

			} else {
				report.AddLineAssertionError("Error:<br> El SOPORTE_FISICO esperado es: " + soporteFisicoEsperado + " y es diferente al de la base de datos: " + rtaSoporteFisico);
				System.out.println("##[warning] : Error:\r\n El SOPORTE_FISICO esperado es: " + soporteFisicoEsperado + " y es diferente al de la base de datos: " + rtaSoporteFisico + "\r\n");
