...
public class TC_03_API_PP{
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_03_API_PP\r\n");
			...
			//PUT - Habilitacion Tarjeta Física
			if (!token.isEmpty())
			{
			...
			//Si falla la validacion el resultado de la prueba es false
				...
				report.AddLine("La tarjeta se habilito correctamente. El nuevo estado de la tarjeta " + REFERENCIA + " de la cuenta " + ID_CUENTA + " es: " + resp);
				System.out.println("##[section] : La tarjeta se habilito correctamente. El nuevo estado de la tarjeta " + REFERENCIA + " de la cuenta " + ID_CUENTA + " es: " + resp + "\r\n");	
			       }		
