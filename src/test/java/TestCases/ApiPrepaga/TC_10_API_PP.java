...
public class TC_10_API_PP{
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_10_API_PP\r\n");
			...
			rta = oraResp.oraUpdate(report, "UPDATE TARJETAS SET ID_ESTADO = 1 WHERE ID_CUENTA = " + ID_CUENTA, configEntidad);
