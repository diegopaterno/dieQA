...
import Pasos.GlobalOnLine.TC_19_GO_PASOS;

public class TC_19_WEB_GO {
	WebDriver driver;
	...
	public boolean Test(Datasources data,Reports report, DriverManager DM, int iteration,String name, String configEntidad, String cuentas_generales) {
		...
		try {			
            ...
            System.out.println("Configuring TC_19_WEB_GO\r\n");
			...
			TC_19_GO_PASOS tc = new TC_19_GO_PASOS();
			...
			String ID_TARJETA_VIGENTE = JsonPath.from(cuentas_generales).get("CUENTA_FISICA_2.id_tarjeta");
