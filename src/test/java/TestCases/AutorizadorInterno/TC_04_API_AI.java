...
public class TC_04_API_AI{
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_04_API_AI\r\n");
			...
			resulEsperado[0] = "1530";//DISPONIBLE
			resulEsperado[1] = "370";//IMPORTE_PEND_COMPRAS
			...
			String pathPreCondi = "./API_Requests/Autorizador/TC_03_CompraLocal_Banda15,56.txt";
			String disponible_PreCondi = "1530";
			String importe_pend_compras_PreCondi = "370";
			...
			if(respuestaPreCondi) {
				report.AddLine("La Compra Local como precondicion al reverso total se genero correctamente");
				System.out.println("##[section] : La Compra Local como precondicion al reverso se genero correctamente\r\n");
			}
			else {
				report.AddLine("La Compra Local como precondicion al reverso total no se genero");
				System.out.println("##[warning] : La Compra Local como precondicion al reverso no se genero\r\n");
				result = false;
			}
			
			report.AddLine("Ejecutando Reverso de la Compra Local generada previamente");
			System.out.println("Ejecutando Reverso de la Compra Local generada previamente\r\n");
