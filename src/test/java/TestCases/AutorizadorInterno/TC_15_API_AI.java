...
public class TC_15_API_AI{
	WebDriver driver;
	
	// Compra Local - Forzada
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_15_API_AI\r\n");

			//SET VARIABLES
			// Ruta donde se encuentra el archivo con el Body que se envia en el metodo Post
			String path = "./API_Requests/Autorizador/TC_15_Compra_Local_Forzada.txt";
			String token = "";
			String bodyData = "";
			String respuesta1 = "";
			String respuesta2 = "";
			...
			resulEsperado[0] = "-300";//DISPONIBLE
			resulEsperado[1] = "300";//IMPORTE_PEND_COMPRAS
