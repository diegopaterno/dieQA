...
public class TC_03_API_AI{
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_03_API_AI\r\n");

			//SET VARIABLES
			// Ruta donde se encuentra el archivo con el Body que se envia en el metodo Post
			String path = "./API_Requests/Autorizador/TC_03_CompraLocal_Banda15,56.txt";
			String token = "";
			String bodyData = "";
			String respuesta1 = "";
			String respuesta2 = "";
			...
			resulEsperado[0] = "1514.44";//DISPONIBLE
			resulEsperado[1] = "385.56";//IMPORTE_PEND_COMPRAS
