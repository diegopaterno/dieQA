...
public class TC_12_API_AI{
	WebDriver driver;
	
	// PRUEBA QUE REQUIERE LA EJECUCION DE DEL TC11 (Compra Local - Ecommer )
	// Reverso Total - Compra Local - Ecommer 
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_12_API_AI\r\n");

			//SET VARIABLES
			// Ruta donde se encuentra el archivo con el Body que se envia en el metodo Post
			String path = "./API_Requests/Autorizador/TC_12_ReversoTotalCompraLocal_Ecommer555.00.txt";
			String token = "";
			String bodyData = "";
			String respuesta1 = "";
			String respuesta2 = "";
			...
			String pathPreCondi = "./API_Requests/Autorizador/TC_11_CompraLocal_Ecommer555.00.txt";
			...
			respuestaPreCondi = AI.preCondicionParaReversosAI(report, DM,pathPreCondi,disponible_PreCondi,importe_pend_compras_PreCondi, configEntidad,ID_CUENTA, NRO_TARJETA, VENCIMIENTO);

			if(respuestaPreCondi) {
				report.AddLine("La Compra Local Ecommer como precondicion al reverso se genero correctamente");
				System.out.println("##[section] : La Compra Local Ecommer como precondicion al reverso se genero correctamente\r\n");
			}
			else {
				report.AddLine("La Compra Local Ecommer como precondicion al reverso no se genero");
				System.out.println("##[warning] : La Compra Local Ecommer como precondicion al reverso no se genero\r\n");
				result = false;
			}

			report.AddLine("Ejecutando Reverso de la Compra Local Ecommer generada previamente");
			System.out.println("Ejecutando Reverso de la Compra Local Ecommer generada previamente\r\n");			
			...
			//POST - Reverso Total - Compra Local - Ecommer s
			...
			rtaRollback = oraResp.oraUpdate(report, "UPDATE CUENTAS_MONEDA\r\n"
					+ "SET SALDO = 1900, DISPONIBLE = 415.02, DISPONIBLE_ADELANTO = 1900,\r\n"
					+ "IMPORTE_COMPRAS = 0, IMPORTE_ADELANTOS = 0, IMPORTE_PEND_COMPRAS = 1484.98, \r\n"
