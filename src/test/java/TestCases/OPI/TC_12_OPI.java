...
public class TC_12_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_12_OPI\r\n");
			...
			String de39 = "00";
			String idEstado = "0";
			String disponible = "3297.7916";
			String impPendComp = "4041.88";
			String impAjustePend = "2660.3284";
			String res;
			boolean validaRes;
			int rtaQuery = 0;
			...
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_12_OPI.xml", configEntidad);
