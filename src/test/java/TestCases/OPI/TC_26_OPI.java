...
public class TC_26_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_26_OPI\r\n");
			...
			String ID_POSICION_IMPOSITIVA_RI = "1";//RESPONSABLE INSCRIPTO
			String ID_POSICION_IMPOSITIVA_EXENTO = "5";//EXENTO
			//Resultados esperados
			String de39 = "00";
			String idEstado = "0";
			String disponible = "9317.604";
			String impPendCompras = "477.2";
			String impAjustePend = "205.196";
			String res;
			boolean validaRes;
			int rtaQuery = 0;
			...
			opiAcciones.setPosicionImpositiva(oraResp, ppCondi, report, dispInicial, impPendCompras, impAjustePend, ID_CUENTA, configEntidad, ID_POSICION_IMPOSITIVA_RI);
			...
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_26_OPI.xml", configEntidad);
			...
			opiAcciones.setPosicionImpositiva(oraResp, ppCondi, report, dispInicial, impPendCompras, impAjustePend, ID_CUENTA, configEntidad, ID_POSICION_IMPOSITIVA_EXENTO);
