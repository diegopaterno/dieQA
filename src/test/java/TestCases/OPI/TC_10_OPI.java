...
public class TC_10_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_10_OPI\r\n");
			...
			String de39 = "00";
			String idEstado = "0";
			String disponible = "3377.4812";
			String impPendComp = "3994.16";
			String impAjustePend = "2628.3588";
			String res;
			boolean validaRes;
			int rtaQuery = 0;
			...
			ppCondi.preCondicionBD(report, rtaQuery);
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_10_OPI.xml", configEntidad);
