...
public class TC_22_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_22_OPI\r\n");
			...
			String de39 = "00";
			String idEstado = "0";
			String disponible = "8711.56";
			String impPendComp = "954.4";
			String impAjustePend = "334.04";
			String res;
			boolean validaRes;
			int rtaQuery = 0;
			...
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_22_OPI.xml", configEntidad);
