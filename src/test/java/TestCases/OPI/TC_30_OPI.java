...
public class TC_30_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {	
			...
			System.out.println("Configuring TC_30_OPI\r\n");
			...
			String de39 = "00";
			String idEstado = "0";
			String disponible = "9990";
			String disponibleAdelanto = "9990";
			String impPendAdelanto = "10";
			...
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_30_OPI.xml", configEntidad);
