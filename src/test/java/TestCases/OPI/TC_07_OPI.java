...
public class TC_07_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_07_OPI\r\n");
			...
			String de39 = "00";
			String idEstado = "0";
			String disponible = "4891.6336";
			String impPendComp = "3087.48";
			String impAjustePend = "2020.8864";
			String res;
			boolean validaRes;
			int rtaQuery = 0;
			...
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_07_OPI.xml", configEntidad);
