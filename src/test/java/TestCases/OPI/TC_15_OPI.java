...
public class TC_15_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_15_OPI\r\n");
			...
			opiAcciones.preCondicion_CM_Tarjetas(oraResp, ppCondi, report, dispInicial, pendCompras, ajustePend, ID_CUENTA, ID_ESTADO, configEntidad);
			
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_15_OPI.xml", configEntidad);
			...
			opiAcciones.postCondicion_CM_Tarjetas(oraResp, ppCondi, report, dispInicial, pendCompras, ajustePend, ID_CUENTA, ID_ESTADO, configEntidad);	
