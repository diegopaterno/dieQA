...
public class TC_25_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_25_OPI\r\n");
			...
			String ID_PROVINCIA = "1";
			String ID_CODIGO_POSTAL = "1004";
			String ID_PROVINCIA_ROLLBACK = "15";
			String ID_CODIGO_POSTAL_ROLLBACK = "8300";
			//Resultados esperados
			String de39 = "00";
			String idEstado = "0";
			String disponible = "9217.394";
			String impPendCompras = "477.2";
			String impAjustePend = "305.406";
			String res;
			boolean validaRes;
			int rtaQuery = 0;
			...
			//Precondicion de cuentas_moneda y cotizaciones
			...
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_25_OPI.xml", configEntidad);
