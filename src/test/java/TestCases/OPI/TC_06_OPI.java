...
public class TC_06_OPI {
	...
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {		
			...
			System.out.println("Configuring TC_06_OPI\r\n");

			//Set Variables
			//Datos para generar autorizacion de precondicion
			String dispInicial = "6063.1";
			String pendCompras = "2386";
			String ajustePend = "1550.9";
			String ID_CUENTA = JsonPath.from(cuentas_generales).get("CUENTA_FISICA_1.cuenta_fisica");
			String tid = "MCC0113SP1015  ";			
			//Resultados esperados
			String de39 = "00";
			String idEstado = "2";
			String disponibleEsperado = "6063.1";
			String impPendCompEsperado = "2386";
			String impAjustePendEsperado = "1550.9";
			String res;
			//XML de la autorizacion de la preconcidion
			String XML = "TC_05_OPI.xml";
			boolean validaRes;			
			...
			if(respuestaPreCondi) {
				report.AddLine("La Devolución Total Ecommer como precondicion al reverso se genero correctamente");
				System.out.println("##[section] : La Devolución Total Ecommer como precondicion al reverso se genero correctamente\r\n");
			}
			else {
				report.AddLine("La Devolución Total Ecommer como precondicion al reverso no se genero");
				System.out.println("##[warning] : La Devolución Total Ecommer como precondicion al reverso no se genero\r\n");
				result = false;
			}

			report.AddLine("Ejecutando Reverso de la Devolución Total Ecommer generada previamente");
			System.out.println("Ejecutando Reverso de la Devolución Total Ecommer generada previamente\r\n");
			
			//EJECUCION OPI
			res = opiCmd.sshSendCmd(report, "TC_06_OPI.xml", configEntidad);
