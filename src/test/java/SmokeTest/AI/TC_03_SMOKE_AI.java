...
public class TC_03_SMOKE_AI {
	WebDriver driver;
	
	// compraLocaCompraLocalChiplManual
	public boolean Test(Reports report, DriverManager DM, int iteration, String name, String configEntidad, String cuentas_generales) {
		...
		try {
			...
			System.out.println("Configuring TC_03_SMOKE_AI \r\n");

			//SET VARIABLES
			// Ruta donde se encuentra el archivo con el Body que se envia en el metodo Post
			String path = "./API_Requests/Autorizador/TC_05_CompraLocal_Chip214.00.txt";
			String token = "";
			String bodyData = "";
			String respBody = "";
