...
public class OpiRegresionVisaPrepagaCtfUAT {
	static
	...
	@Test(priority=1)
	void opiPrepagaCompraLocalManualCtfYPresentacionUAT() {	
		// DEFINITIONS
		...
		String nroTC = "01";
		String name = "TC_" + nroTC + "_AUT_OPI_VISA_LEMON" + entidad + "Prepaga - Compra Local - Manual - CTF ENTRANTE - PRESENTACIONES VISA LEMON PERU UAT";
		String TCFilesPath = "./TC_Files/OPI/" + entidad + "/REGRESION/VISA/PREPAGAUAT/TC_" + nroTC;
		...
		status = AUT_OPI_OPERACIONES.CompraCTFLemonUAT(data, report, DM, x, name, configEntidad, entidad, TCFilesPath);
