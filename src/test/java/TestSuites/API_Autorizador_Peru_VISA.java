...
public class API_Autorizador_Peru_VISA {
	...
	static void initAll() throws IOException {
		...
		entidad = JsonPath.from(configEntidad).getString("ENTIDAD.id_entidad_peru");
	...
	void TC_1_compraApiAutorizador() {
		...
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad +"/VISA/DESA/TC_" + nroTC;
		...
		status = AUT_API_OPERACIONES.compraApiAutorizadorLemon(report, name, configEntidad, entidad, TCFilesPath, endPoint,
				statusCodeEsperado);
	...
	void TC_2_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A178";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " compra - devolucion - local - manual";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String producto = "1";
		...
		repoVar.setDataMsg(name);
		// SET THE EXECUTION PLAN
		status = AUT_API_OPERACIONES.compraDevolucionApiAutorizadorLemon(report, name, configEntidad, entidad, TCFilesPath, endPoint, statusCodeEsperado);
		// Configuracion de variables para el armado del reporte
		repoVar.setResult(status);
		// Verificamos si la ejecucion falla y guardamos el status Gral.
		if (status == false) {
	...
	void TC_A196b_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A196";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.desa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
		...
		repoVar.setDataMsg(name);
		// SET THE EXECUTION PLAN
		status = AUT_API_OPERACIONES.compraReversoApiAutorizadorLemon(report, name, configEntidad, entidad, TCFilesPath, endPoint, statusCodeEsperado);
		// Configuracion de variables para el armado del reporte
		repoVar.setResult(status);
		// Verificamos si la ejecucion falla y guardamos el status Gral.
		if (status == false) {
	...
	void TC_2_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "02";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " compra - local - banda";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
	...
	void TC_3_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "03";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " compra - local - codigo";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_7_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "07";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad
	...
	void TC_4_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "04";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " compra - local - chip";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_5_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "05";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " compra - local - ecommerce";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_6_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "06";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " compra - local - contactless";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_86_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "86";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEBITO AUT - MANUAL - BIN EXT - POSNET LOCAL - MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_98_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "98";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " EXTRACCION / ADELANTO -  - MANUAL - TARJETA LOCAL - POSNET LOCAL - MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_99_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "99";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " EXTRACCION / ADELANTO -  -  - TARJETA LOCAL - POSNET LOCAL - MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A124_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A124";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A125_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A125";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - BANDA - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A126_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A126";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A127_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A127";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A128_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A128";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - ECOMMERCE - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A129_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A129";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A130_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A130";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A131_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A131";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - BANDA - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A132_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A132";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A133_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A133";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A134_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A134";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - ECOMMERCE - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A135_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A135";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A136_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A136";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A137_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A137";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - BANDA - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A138_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A138";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A139_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A139";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A140_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A140";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A141_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A141";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A142_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A142";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A143_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A143";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - BANDA - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A144_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A144";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A145_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A145";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A146_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A146";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A147_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A147";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A172_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A172";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A173_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A173";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - BANDA - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A174_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A174";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A175_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A175";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A176_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A176";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL- ECOMMERCE - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A177_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A177";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A178_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A178";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A179_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A179";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - BANDA - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A180_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A180";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A181_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A181";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A182_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A182";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - ECOMMERCE - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A183_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A183";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A184_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A184";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A185_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A185";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - BANDA - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A186_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A186";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A187_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A187";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A188_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A188";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A189_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A189";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A190_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A190";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A192_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A192";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A193_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A193";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A194_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A194";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A195_compraDevolucionApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A195";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " DEVOLUCION PARCIAL - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A197_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A197";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - BANDA- TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A198_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A198";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A199_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A199";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A200_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A200";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO - ECOMMERCE - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A201_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A201";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A202_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A202";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A203_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A203";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - BANDA- TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A204_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A204";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL  - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A205_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A205";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A206_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A206";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO - ECOMMERCE - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_A207_compraReversoApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A207";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + " REVERSO PARCIAL - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_148_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a148";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_149_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a149";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - BANDA- TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_150_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a150";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_151_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a151";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_153_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a153";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_154_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a154";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - MANUAL - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_155_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a155";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - BANDA- TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_156_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a156";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CODIGO - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_157_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a157";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CHIP - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_159_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a159";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CONTACTLESS - TARJETA LOCAL - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_160_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a160";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_161_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a161";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - BANDA- TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_162_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a162";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_163_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a163";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_164_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a164";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_165_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a165";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_166_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a166";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_167_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a167";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - BANDA- TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_168_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a168";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_169_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a169";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_170_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a170";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_171_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a171";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_208_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a208";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_209_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a209";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - BANDA- TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_210_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a210";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_211_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a211";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_212_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a212";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_213_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a213";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA LOCAL";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_214_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a214";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - MANUAL - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_215_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a215";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - BANDA- TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_216_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a216";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - CODIGO - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_217x_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a217";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - CHIP - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_218_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "a218";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - ECOMMERCE - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
	...
	void TC_219_compraApiAutorizador() {
		...
		boolean status = false;
		String nroTC = "A219";
		String name = "TC_" + nroTC + "_API_OPERACIONES_VISA_" + entidad + "REVERSO PARCIAL - CONTACTLESS - TARJETA EXT - POSNET LOCAL- MONEDA EXT";
		String TCFilesPath = "./TC_Files/API_AUTORIZADOR/" + entidad + "/VISA/DESA/TC_" + nroTC;
		String msg = "True;Resultado de la ejecucion OK. TC: " + name;
		String endPoint = "http://AutorizadorGw.api.qa.global.globalprocessing.net.ar/api/emision/autorizacion";
		String statusCodeEsperado = "201";
