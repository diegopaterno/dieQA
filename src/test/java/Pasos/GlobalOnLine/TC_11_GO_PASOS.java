...
public class TC_11_GO_PASOS {
	...
	public void pagina2(Datasources data,Reports report, DriverManager DM, int iteration,String name,Repo_WebRepository repo, String configEntidad, String descripcion_sucursal, String descripcion_ga, String descripcion_producto, String ID_PRODUCTO) throws InterruptedException {
		...
		report.AddLine("Cargo el input select Tipo de tarjeta: Tarjeta Fisica");
		System.out.println("Cargo el input select Tipo de tarjeta: Tarjeta Fisica\r\n");
		repo.get_obj_selectOptionByName("FormatoTarjeta", "Tarjeta Física").click();

		report.AddLine("Cargo el input select Entrega de Tarjeta: Domicilio Legal");
		System.out.println("Cargo el input select Entrega de Tarjeta: Domicilio Legal\r\n");
	...
	public void pagina3(Datasources data,Reports report, DriverManager DM, int iteration,String name,Repo_WebRepository repo, String dni, String cuil) throws InterruptedException {
		...
		report.AddLine("Se visualilzan los datos personales cargados");
		System.out.println("Se visualilzan los datos personales cargados\r\n");
		report.Screenshot(name);

		report.AddLine("Cargo el input CUIL: "+cuil);
		System.out.println("Cargo el input CUIL: "+cuil+ "\r\n");
		...
		repo.get_obj_inputTextByName("DomicilioLegal.Direccion").sendKeys("Calla Falsa");
		...
		report.AddLine("Se visualizan los datos del domicilio");
		System.out.println("Se visualizan los datos del domicilio\r\n");
		report.Screenshot(name);
