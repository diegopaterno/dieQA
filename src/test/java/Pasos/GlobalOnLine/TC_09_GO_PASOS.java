...
public class TC_09_GO_PASOS {
	...
	public void pagina1(Datasources data,Reports report, DriverManager DM, int iteration,String name,Repo_WebRepository repo, String ID_CUENTA) throws InterruptedException {
		...
		report.AddLine("Verificacion de la busqueda");
		System.out.println("Verificacion de la busqueda\r\n");
	...
	public void pagina2(Datasources data,Reports report, DriverManager DM, int iteration,String name,Repo_WebRepository repo) throws InterruptedException {
		...
		report.AddLine("Se cambia el Estado: Baja");
		System.out.println("Se cambia el Estado: Baja\r\n");
		repo.get_obj_selectOptionByName("EstadoCuenta", "Baja").click();
		
		Thread.sleep(2000);
		
		report.AddLine("Se verifica que se cambie a estado BAJA");
		System.out.println("Se verifica que se cambie a estado BAJA\r\n");
		report.Screenshot(name);
